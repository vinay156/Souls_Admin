...
const routes = [
  ...
  { path: '/team/add', exact: true,  name: 'Add', component: Team },
  { path: '/team', exact: true,  name: 'Team', component: ViewTeam },
  { path: '/team/:id', exact: true,  name: 'TeamMember', component: TeamMember },
